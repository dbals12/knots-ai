      ...
      <div className="px-6 py-10 flex flex-col flex-1 justify-between min-h-full">
        ...
        <div>
          ...
          <div className="text-left mb-8">
            ...
            <p className="mt-6 mb-16 font-medium leading-7 text-[11px] md:text-xs w-full space-y-2">
              {/* 첫째줄: 연하게 -> 진하게 */}
              <span className="block text-left text-transparent bg-clip-text bg-gradient-to-r from-gray-35--400 via-gray-500 to-gray-400 whitespace-nowrap">
                말하는 대로 완성되는 나만의 커리어 콘텐츠.
              </span>

              {/* 둘째줄: 진하게 -> 연하게 */}
              {/* whitespace-nowrap: 강제 줄바꿈 금지 / tracking-tighter: 자간 좁힘 */}
              <span className="block text-right text-transparent bg-clip-text bg-gradient-to-r from-gray-400 via-gray-500 to-gray-400 whitespace-nowrap tracking-tighter">
