      ...
      <div className="px-6 py-10 flex flex-col flex-1 justify-between min-h-full">
        ...
        <div>
          ...
          <div className="text-left mb-8">
            ...
            <p className="mt-6 mb-14 font-medium leading-7 text-[11px] md:text-xs w-full space-y-2">
              {/* 첫째줄: 연하게 -> 진하게 */}
              <span className="block text-right text-transparent bg-clip-text bg-gradient-to-r from-gray-400 via-gray-500 to-gray-400 whitespace-nowrap">
