...
**개인 프로젝트.** React + Supabase(Auth · DB · Edge Functions) + OpenAI. AI 앱 빌더(Lovable)로 프로토타이핑 후 직접 확장.
...
`screenshots/` 참고 — 또는 [라이브 데모](https://knots-ai.lovable.app)에서 직접 확인.
...
이 프로젝트는 [Lovable](https://lovable.dev)로 빌드했고, [Lovable 에디터](https://lovable.dev/projects/5dfb626d-9d5a-4e3e-b8dd-ce8424cdfc7e)와 GitHub `main`이 양방향 동기화됩니다.
